  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-8">
      ...
      <div
        ...
        style={{ background: `linear-gradient(135deg, rgba(204,0,0,0.18) 0%, rgba(204,0,0,0.05) 60%, transparent 100%)`, border: `1px solid ${SYSTEM_COLOR_MID}` }}
      >
        <div
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-3xl font-black text-white leading-tight">Sega 32X</h1>
          <p className="text-sm mt-1" style={{ color: 'var(--color-oasis-text-muted)' }}>
            Genesis add-on · Online relay via RetroArch + PicoDrive · Up to 4 players
          </p>
        </div>
        <div className="hidden sm:flex flex-col items-end gap-1 shrink-0">
          <span className="text-xs font-semibold" style={{ color: 'var(--color-oasis-text-muted)' }}>
            {GAMES_32X.length} games
          </span>
          <span className="text-xs" style={{ color: 'var(--color-oasis-text-muted)' }}>
            5th Generation · 1994
          </span>
