...
const DREAMCAST_GAMES: DreamcastGame[] = [
  { id: 'dc-sonic-adventure-2',  title: 'Sonic Adventure 2',    genre: 'Platformer',  genreEmoji: '🦔', maxPlayers: 2, competitive: true },
  { id: 'dc-power-stone-2',      title: 'Power Stone 2',        genre: 'Fighting',    genreEmoji: '⚡', maxPlayers: 4, competitive: true },
  { id: 'dc-marvel-vs-capcom-2', title: 'Marvel vs. Capcom 2',  genre: 'Fighting',    genreEmoji: '🦸', maxPlayers: 2, competitive: true },
  { id: 'dc-soul-calibur',       title: 'Soul Calibur',         genre: 'Fighting',    genreEmoji: '⚔️', maxPlayers: 2, competitive: true },
  { id: 'dc-crazy-taxi',         title: 'Crazy Taxi',           genre: 'Racing',      genreEmoji: '🚕', maxPlayers: 1 },
  { id: 'dc-virtua-tennis',      title: 'Virtua Tennis',        genre: 'Sports',      genreEmoji: '🎾', maxPlayers: 4, competitive: true },
  { id: 'dc-nba-2k2',            title: 'NBA 2K2',              genre: 'Sports',      genreEmoji: '🏀', maxPlayers: 2, competitive: true },
  { id: 'dc-project-justice',    title: 'Project Justice',      genre: 'Fighting',    genreEmoji: '🏫', maxPlayers: 2, competitive: true },
  { id: 'dc-jet-grind-radio',    title: 'Jet Grind Radio',      genre: 'Action',      genreEmoji: '🛼', maxPlayers: 1 },
];
    ...
    >
      ...
      <div>
        <p className="text-sm font-bold" style={{ color: '#fb923c' }}>
          SEGA Dreamcast Relay Netplay via RetroArch + Flycast
        </p>
        <p className="text-xs mt-0.5" style={{ color: 'var(--color-oasis-text-muted)' }}>
          All Dreamcast sessions use RetroOasis TCP relay netplay with RetroArch and the
          Flycast core. No port forwarding required. ROM files (.gdi, .cdi, .chd) are
          auto-detected from your library. Recommended core:
          <code className="mx-1 px-1 rounded" style={{ background: 'rgba(255,102,0,0.2)', color: '#fdba74' }}>
            flycast_libretro.so
          </code>
        </p>
      </div>
...
function DreamcastGameCard({
  ...
  game: DreamcastGame;
  onHost: (game: DreamcastGame) => void;
  onQuickMatch: (game: DreamcastGame) => void;
  openRooms: number;
}) {
  return (
    <div
...
export default function DreamcastPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--color-oasis-text-muted)' }}>
            Online relay sessions via RetroArch + Flycast · Up to 4 players · No port forwarding needed
          </p>
        </div>
      </div>
      ...
      {/* Tab content */}
      {activeTab === 'lobby' && <LobbyPanel games={DREAMCAST_GAMES} />}
