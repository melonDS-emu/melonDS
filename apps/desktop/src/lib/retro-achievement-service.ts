...
export function gameIdToTitle(gameId: string): string {
  const TITLES: Record<string, string> = {
    ...
    'wii-super-smash-bros-brawl': 'Super Smash Bros. Brawl',
    'wii-new-super-mario-bros-wii': 'New Super Mario Bros. Wii',
    'wii-donkey-kong-country-returns': 'Donkey Kong Country Returns',
    'wii-mario-party-8': 'Mario Party 8',
