...
void DSi_SDHost::Reset()
{
    ...
    if (Num == 0)
    {
        ...
        {
            sd = new DSi_MMCStorage(this, false, DSi::SDIOFile, Platform::files[Platform::DsiSd].FileData, Platform::files[Platform::DsiSd].FileLength);
        ...
        mmc = new DSi_MMCStorage(this, true, DSi::SDMMCFile, Platform::files[Platform::DsiNand].FileData, Platform::files[Platform::DsiNand].FileLength);
