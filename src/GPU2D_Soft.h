...
constexpr array2<u8, 16, 256> MosaicTable = []() constexpr
{
    array2<u8, 16, 256> table {};
...
private:
    ...
    u8* CurBGXMosaicTable = nullptr;

    array2<u8, 16, 256> MosaicTable = []() constexpr
    {
        array2<u8, 16, 256> table {};
        // initialize mosaic table
        for (int m = 0; m < 16; m++)
