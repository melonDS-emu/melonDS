...
const u32 MemBlockNWRAM_BOffset = MemBlockNWRAM_AOffset + RoundUp(DSiNWRAMSize);
const u32 MemBlockNWRAM_COffset = MemBlockNWRAM_BOffset + RoundUp(DSiNWRAMSize);
const u32 MemoryTotalSize = MemBlockNWRAM_COffset + RoundUp(DSiNWRAMSize);
...
#ifdef JIT_ENABLED
public:
    explicit ARMJIT_Memory(melonDS::NDS& nds) noexcept;
