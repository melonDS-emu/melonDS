...
{
public:
    ARM(u32 num, const InitArgs& args, const std::optional<GDBArguments>& gdbArgs, melonDS::NDS& nds);
...
protected:
    virtual u8 BusRead8(u32 addr) noexcept = 0;
    virtual u16 BusRead16(u32 addr) noexcept = 0;
    virtual u32 BusRead32(u32 addr) noexcept = 0;
    virtual void BusWrite8(u32 addr, u8 val) noexcept = 0;
    virtual void BusWrite16(u32 addr, u16 val) noexcept = 0;
    virtual void BusWrite32(u32 addr, u32 val) noexcept = 0;
    melonDS::NDS& NDS;
...
{
public:
    ARMv5(const InitArgs& args, melonDS::NDS& nds);
    ~ARMv5();
...
protected:
    u8 BusRead8(u32 addr) noexcept override;
    u16 BusRead16(u32 addr) noexcept override;
    u32 BusRead32(u32 addr) noexcept override;
    void BusWrite8(u32 addr, u8 val) noexcept override;
    void BusWrite16(u32 addr, u16 val) noexcept override;
    void BusWrite32(u32 addr, u32 val) noexcept override;
};

class ARMv4 : public ARM
{
public:
    ARMv4(const InitArgs& args, melonDS::NDS& nds);
