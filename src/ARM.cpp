...
ARM::ARM(u32 num, const InitArgs& args, const std::optional<GDBArguments>& gdbArgs, melonDS::NDS& nds) :
#ifdef GDBSTUB_ENABLED
...
ARMv5::ARMv5(const InitArgs& args, melonDS::NDS& nds) : ARM(0, args, args.GDBARM9, nds)
{
...
ARMv4::ARMv4(const InitArgs& args, melonDS::NDS& nds) : ARM(1, args, args.GDBARM7, nds)
{
    //
}
...
u8 ARMv5::BusRead8(u32 addr) noexcept
{
    return NDS.ARM9Read8(addr);
}

u16 ARMv5::BusRead16(u32 addr) noexcept
{
    return NDS.ARM9Read16(addr);
}

u32 ARMv5::BusRead32(u32 addr) noexcept
{
    return NDS.ARM9Read32(addr);
}

void ARMv5::BusWrite8(u32 addr, u8 val) noexcept
{
    NDS.ARM9Write8(addr, val);
}

void ARMv5::BusWrite16(u32 addr, u16 val) noexcept
{
    NDS.ARM9Write16(addr, val);
}

void ARMv5::BusWrite32(u32 addr, u32 val) noexcept
{
    NDS.ARM9Write32(addr, val);
}

u8 ARMv4::BusRead8(u32 addr) noexcept
{
    return NDS.ARM7Read8(addr);
}

u16 ARMv4::BusRead16(u32 addr) noexcept
{
    return NDS.ARM7Read16(addr);
}

u32 ARMv4::BusRead32(u32 addr) noexcept
{
    return NDS.ARM7Read32(addr);
}

void ARMv4::BusWrite8(u32 addr, u8 val) noexcept
{
    NDS.ARM7Write8(addr, val);
}

void ARMv4::BusWrite16(u32 addr, u16 val) noexcept
{
    NDS.ARM7Write16(addr, val);
}

void ARMv4::BusWrite32(u32 addr, u32 val) noexcept
{
