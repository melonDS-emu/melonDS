...
u8 Read8(u32 addr)
{
    ...
    Platform::LogMsg("unknown SPU read8 %08X\n", addr);
    return 0;
}
...
u16 Read16(u32 addr)
{
    ...
    Platform::LogMsg("unknown SPU read16 %08X\n", addr);
    return 0;
}
...
u32 Read32(u32 addr)
{
    ...
    Platform::LogMsg("unknown SPU read32 %08X\n", addr);
    return 0;
}
...
void Write8(u32 addr, u8 val)
{
    ...
    else
    {
        ...
        case 0x04000508:
            ...
            if (val & 0x03) Platform::LogMsg("!! UNSUPPORTED SPU CAPTURE MODE %02X\n", val);
            return;
        case 0x04000509:
    ...
    Platform::LogMsg("unknown SPU write8 %08X %02X\n", addr, val);
}
...
void Write16(u32 addr, u16 val)
{
    ...
    else
    {
        ...
        case 0x04000508:
            ...
            if (val & 0x0303) Platform::LogMsg("!! UNSUPPORTED SPU CAPTURE MODE %04X\n", val);
            return;
    ...
    Platform::LogMsg("unknown SPU write16 %08X %04X\n", addr, val);
}
